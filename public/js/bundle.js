        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged successfully');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', _context2.t0 //  'Error logging out,please try again!'
            );
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGV2YXBwbWVkIiwiYSI6ImNrN2l2azZwMDBuOXEzb254dTh1N29uejEifQ.GhDBCaWfSt4CsjXgUuyPHA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/mapbox/streets-v11',
    scrollZoom: false //,zoom: 9 //starting zoom
  ...
  locations.forEach(function (loc) {
    //Create marker
    var el = document.createElement('div'); //personalizing marker style

    el.className = 'marker';
    console.log(loc.coordinates); //add marker
...
var userData = document.getElementById('user-data-form');
var userPassword = document.getElementById('user-password-form');
...
if (userData) {
  userData.addEventListener('submit', function (e) {
    ...
    console.log(form);
    (0, _updateData.updateUserSettings)(form, 'data');
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _updateData.updateUserSettings)({
...
},{"babel-polyfill":"../../node_modules/babel-polyfill/lib/index.js","./login":"login.js","./updateData":"updateData.js","./mapbox":"mapbox.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
